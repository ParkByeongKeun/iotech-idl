...
type ReadDataListRequest struct {
	...
	SensorSerial []uint64 `protobuf:"varint,1,rep,packed,name=sensor_serial,json=sensorSerial,proto3" json:"sensor_serial,omitempty"`
...
func (x *ReadDataListRequest) GetSensorSerial() []uint64 {
	if x != nil {
...
var file_main_control_proto_rawDesc = []byte{
	...
	0x65, 0x6e, 0x73, 0x6f, 0x72, 0x5f, 0x73, 0x65, 0x72, 0x69, 0x61, 0x6c, 0x18, 0x01, 0x20, 0x03,
	0x28, 0x04, 0x52, 0x0c, 0x73, 0x65, 0x6e, 0x73, 0x6f, 0x72, 0x53, 0x65, 0x72, 0x69, 0x61, 0x6c,
